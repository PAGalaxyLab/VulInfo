...
## Vul detail ##
In the router module `hosts_info`, user can setup block host with http post request. An normal request looks like below.

![](normal_post_request.png)

After setup block host, `hosts_info` module will save data to config file.
